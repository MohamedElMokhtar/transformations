...
with all_statuts_usagers as (
  ...
  from {{ source('__raw_', 'ahs_type_statut') }}
  ...
  from {{ source('__raw_', 'csm_type_statut') }}
  ...
  select
    ...
    _ab_cdc_updated_at::timestamp as _ab_cdc_updated_at,
    _ab_cdc_deleted_at::timestamp as _ab_cdc_deleted_at
  from {{ source('__raw_', 'occ_type_statut') }}
  ...
  select
    ...
    _ab_cdc_updated_at::timestamp as _ab_cdc_updated_at,
    _ab_cdc_deleted_at::timestamp as _ab_cdc_deleted_at
  from {{ source('__raw_', 'cz_type_statut') }}
  ...
  select
    ...
    _ab_cdc_updated_at::timestamp as _ab_cdc_updated_at,
    _ab_cdc_deleted_at::timestamp as _ab_cdc_deleted_at
  from {{ source('__raw_', 'sahara_type_statut') }}
),
...
, deleted_records as (
  ...
  from {{ this }} t
  inner join all_statuts_usagers s
