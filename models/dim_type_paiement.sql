...
with all_type_paiement as (
 ...
 designation_latin as type_paie,
  ...
  from {{ source('__raw_', 'ahs_type_paiement') }}                                       -- ######################## To be changed
 ...
 designation_latin as type_paie,
  ...
  from {{ source('__raw_', 'csm_type_paiement') }}                                       -- ######################## To be changed
 ...
 designation_latin as type_paie,
    ...
    _ab_cdc_updated_at::timestamp as _ab_cdc_updated_at,
    _ab_cdc_deleted_at::timestamp as _ab_cdc_deleted_at
  from {{ source('__raw_', 'occ_type_paiement') }}                                       -- ######################## To be changed
 ...
 designation_latin as type_paie,
    ...
    _ab_cdc_updated_at::timestamp as _ab_cdc_updated_at,
    _ab_cdc_deleted_at::timestamp as _ab_cdc_deleted_at
  from {{ source('__raw_', 'cz_type_paiement') }}                                       -- ######################## To be changed
 ...
 designation_latin as type_paie,
    ...
    _ab_cdc_updated_at::timestamp as _ab_cdc_updated_at,
    _ab_cdc_deleted_at::timestamp as _ab_cdc_deleted_at
  from {{ source('__raw_', 'sahara_type_paiement') }}                                       -- ######################## To be changed
),
