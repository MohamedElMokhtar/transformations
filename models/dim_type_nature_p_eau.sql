...
with all_type_nature_p_eau as (
  ...
  from {{ source('__raw_', 'ahs_type_nature_p_eau') }}                                       -- ######################## To be changed
  ...
  from {{ source('__raw_', 'csm_type_nature_p_eau') }}                                       -- ######################## To be changed
  ...
  designation_latin as nature_p_eau,
    ...
    _ab_cdc_updated_at::timestamp as _ab_cdc_updated_at,
    _ab_cdc_deleted_at::timestamp as _ab_cdc_deleted_at
  from {{ source('__raw_', 'occ_type_nature_p_eau') }}                                       -- ######################## To be changed
  ...
  designation_latin as nature_p_eau,
    ...
    _ab_cdc_updated_at::timestamp as _ab_cdc_updated_at,
    _ab_cdc_deleted_at::timestamp as _ab_cdc_deleted_at
  from {{ source('__raw_', 'cz_type_nature_p_eau') }}                                       -- ######################## To be changed
  ...
  designation_latin as nature_p_eau,
    ...
    _ab_cdc_updated_at::timestamp as _ab_cdc_updated_at,
    _ab_cdc_deleted_at::timestamp as _ab_cdc_deleted_at
  from {{ source('__raw_', 'sahara_type_nature_p_eau') }}                                       -- ######################## To be changed
),
