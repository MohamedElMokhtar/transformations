...
with all_type_decision_recour as (
  ...
  from {{ source('public', 'ahs_type_decision_recour') }}                                       -- ######################## To be changed
  ...
  from {{ source('public', 'csm_type_decision_recour') }}                                       -- ######################## To be changed
  ...
  select
    ...
    _ab_cdc_updated_at::timestamp as _ab_cdc_updated_at,
    _ab_cdc_deleted_at::timestamp as _ab_cdc_deleted_at
  from {{ source('public', 'occ_type_decision_recour') }}                                       -- ######################## To be changed
  ...
  select
    ...
    _ab_cdc_updated_at::timestamp as _ab_cdc_updated_at,
    _ab_cdc_deleted_at::timestamp as _ab_cdc_deleted_at
  from {{ source('public', 'cz_type_decision_recour') }}                                       -- ######################## To be changed
  ...
  select
    ...
    _ab_cdc_updated_at::timestamp as _ab_cdc_updated_at,
    _ab_cdc_deleted_at::timestamp as _ab_cdc_deleted_at
  from {{ source('public', 'sahara_type_decision_recour') }}                                       -- ######################## To be changed
),
...
s.decision,
  ...
  where
    ...
    (s.decision is distinct from t.decision)                              -- ######################## To be changed THIS PART you put only the data (don't put id)
         -- ######################## To be changed
)
