...
volume as volume_prelevé,
  ...
  from {{ source('public', 'ahs_prelevement_volume') }}                                       -- ######################## To be changed
...
volume as volume_prelevé,
  ...
  from {{ source('public', 'csm_prelevement_volume') }}                                       -- ######################## To be changed
...
volume as volume_prelevé,
    ...
    _ab_cdc_updated_at::timestamp as _ab_cdc_updated_at,
    _ab_cdc_deleted_at::timestamp as _ab_cdc_deleted_at
  from {{ source('public', 'occ_prelevement_volume') }}                                       -- ######################## To be changed
...
volume as volume_prelevé,
    ...
    _ab_cdc_updated_at::timestamp as _ab_cdc_updated_at,
    _ab_cdc_deleted_at::timestamp as _ab_cdc_deleted_at
  from {{ source('public', 'cz_prelevement_volume') }}                                       -- ######################## To be changed
...
volume as volume_prelevé,
    ...
    _ab_cdc_updated_at::timestamp as _ab_cdc_updated_at,
    _ab_cdc_deleted_at::timestamp as _ab_cdc_deleted_at
  from {{ source('public', 'sahara_prelevement_volume') }}                                       -- ######################## To be changed
),
...
s.volume_prelevé,
  ...
  where
    ...
    (s.p_eau_id is distinct from t.p_eau_id)                              -- ######################## To be changed THIS PART you put only the data (don't put id)
   ...
   or (s.exercice_id is distinct from t.exercice_id)
    or (s.volume_prelevé is distinct from t.volume_prelevé)         -- ######################## To be changed
)
