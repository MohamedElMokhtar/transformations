...
with all_exercices as (
  ...
  from {{ source('__raw_', 'ahs_exercices') }}
  ...
  from {{ source('__raw_', 'csm_exercices') }}
  ...
  select
    ...
    _ab_cdc_updated_at::timestamp as _ab_cdc_updated_at,
    _ab_cdc_deleted_at::timestamp as _ab_cdc_deleted_at
  from {{ source('__raw_', 'occ_exercices') }}
  ...
  select
    ...
    _ab_cdc_updated_at::timestamp as _ab_cdc_updated_at,
    _ab_cdc_deleted_at::timestamp as _ab_cdc_deleted_at
  from {{ source('__raw_', 'cz_exercices') }}
  ...
  select
    ...
    _ab_cdc_updated_at::timestamp as _ab_cdc_updated_at,
    _ab_cdc_deleted_at::timestamp as _ab_cdc_deleted_at
  from {{ source('__raw_', 'sahara_exercices') }}
),
...
, changed_records as (
  ...
  where
    ...
    (s.Annee is distinct from t.Annee)
    or (s."Type" is distinct from t."Type")
    or (s.Periode is distinct from t.Periode)
    or (s.Du is distinct from t.Du)
    or (s.au is distinct from t.au)
)
