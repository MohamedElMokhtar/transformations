...
with all_type_activite as (
  ...
  from {{ source('__raw_', 'ahs_recours') }}                                       -- ######################## To be changed
  ...
  from {{ source('__raw_', 'csm_recours') }}                                       -- ######################## To be changed
  ...
  date_recour,
    ...
    _ab_cdc_updated_at::timestamp as _ab_cdc_updated_at,
    _ab_cdc_deleted_at::timestamp as _ab_cdc_deleted_at
  from {{ source('__raw_', 'occ_recours') }}                                       -- ######################## To be changed
  ...
  date_recour,
    ...
    _ab_cdc_updated_at::timestamp as _ab_cdc_updated_at,
    _ab_cdc_deleted_at::timestamp as _ab_cdc_deleted_at
  from {{ source('__raw_', 'cz_recours') }}                                       -- ######################## To be changed
  ...
  date_recour,
    ...
    _ab_cdc_updated_at::timestamp as _ab_cdc_updated_at,
    _ab_cdc_deleted_at::timestamp as _ab_cdc_deleted_at
  from {{ source('__raw_', 'sahara_recours') }}                                       -- ######################## To be changed
),
