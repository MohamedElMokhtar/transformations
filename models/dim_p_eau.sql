...
with all_P_eau as (
 ...
 unite_id as usagers_id, 
  ...
  from {{ source('public', 'ahs_p_eau') }}                                       -- ######################## To be changed
 ...
 unite_id as usagers_id, 
  ...
  from {{ source('public', 'csm_p_eau') }}                                       -- ######################## To be changed
 ...
 unite_id as usagers_id, 
  ...
  date_arret,
    ...
    _ab_cdc_updated_at::timestamp as _ab_cdc_updated_at,
    _ab_cdc_deleted_at::timestamp as _ab_cdc_deleted_at
  from {{ source('public', 'occ_p_eau') }}                                       -- ######################## To be changed
 ...
 unite_id as usagers_id, 
  ...
  date_arret,
    ...
    _ab_cdc_updated_at::timestamp as _ab_cdc_updated_at,
    _ab_cdc_deleted_at::timestamp as _ab_cdc_deleted_at
  from {{ source('public', 'cz_p_eau') }}                                       -- ######################## To be changed
 ...
 unite_id as usagers_id, 
  ...
  date_arret,
    ...
    _ab_cdc_updated_at::timestamp as _ab_cdc_updated_at,
    _ab_cdc_deleted_at::timestamp as _ab_cdc_deleted_at
  from {{ source('public', 'sahara_p_eau') }}                                       -- ######################## To be changed
),
