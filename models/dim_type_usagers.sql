...
Taux_Budjet_Etat,
  ...
  from {{ source('__raw_', 'ahs_type_unite') }}                                       -- ######################## To be changed
...
Taux_Budjet_Etat,
  ...
  from {{ source('__raw_', 'csm_type_unite') }}                                       -- ######################## To be changed
...
Taux_Budjet_Etat,
  ...
  Taux_agire,
    ...
    _ab_cdc_updated_at::timestamp as _ab_cdc_updated_at,
    _ab_cdc_deleted_at::timestamp as _ab_cdc_deleted_at
  from {{ source('__raw_', 'occ_type_unite') }}                                       -- ######################## To be changed
...
Taux_Budjet_Etat,
  ...
  Taux_agire,
    ...
    _ab_cdc_updated_at::timestamp as _ab_cdc_updated_at,
    _ab_cdc_deleted_at::timestamp as _ab_cdc_deleted_at
  from {{ source('__raw_', 'cz_type_unite') }}                                       -- ######################## To be changed
...
Taux_Budjet_Etat,
  ...
  Taux_agire,
    ...
    _ab_cdc_updated_at::timestamp as _ab_cdc_updated_at,
    _ab_cdc_deleted_at::timestamp as _ab_cdc_deleted_at
  from {{ source('__raw_', 'sahara_type_unite') }}                                       -- ######################## To be changed
),
